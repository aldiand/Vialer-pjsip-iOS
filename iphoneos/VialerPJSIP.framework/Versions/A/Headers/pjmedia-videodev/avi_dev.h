 ...
 *
<<<<<<< HEAD:VialerPJSIP.framework/Versions/A/Headers/pjmedia-videodev/avi_dev.h
 * @param id            Device ID.
 * @param param         Structure to receive the settings.
=======
 * @param id		Device ID.
 * @param param		Structure to receive the settings.
>>>>>>> xcframework:iphoneos/VialerPJSIP.framework/Versions/A/Headers/pjmedia-videodev/avi_dev.h
 *
 * @return              PJ_SUCCESS or the appropriate error code.
 */
