...
<<<<<<< HEAD:VialerPJSIP.framework/Versions/A/Headers/pjmedia-audiodev/config.h
#   define PJMEDIA_AUDIO_DEV_HAS_OBOE           0
=======
#   define PJMEDIA_AUDIO_DEV_HAS_OBOE		0
>>>>>>> xcframework:iphoneos/VialerPJSIP.framework/Versions/A/Headers/pjmedia-audiodev/config.h
#endif
...
@subsection getting_started Getting started
 ...
 -# <b>Configure the application's project settings</b>.\n
    ...
    include:
    \code
    #include <VialerPJSIP/pjmedia_audiodev.h>\endcode\n
