 ...
 *
<<<<<<< HEAD:VialerPJSIP.framework/Versions/A/Headers/pjsip/sip_transport.h
 * @param tpmgr     The transport manager.
 * @param pool      Pool to allocate memory for the IP address.
 ...
 * @param pool	    Pool to allocate memory for the IP address.
 * @param prm	    Function input and output parameters.
>>>>>>> xcframework:iphoneos/VialerPJSIP.framework/Versions/A/Headers/pjsip/sip_transport.h
 *
 * @return          PJ_SUCCESS, or the appropriate error code.
 */
