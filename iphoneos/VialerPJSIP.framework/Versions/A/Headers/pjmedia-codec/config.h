...
<<<<<<< HEAD:VialerPJSIP.framework/Versions/A/Headers/pjmedia-codec/config.h
...
#   else
#	define PJMEDIA_HAS_FFMPEG_CODEC_VP8		1
>>>>>>> xcframework:iphoneos/VialerPJSIP.framework/Versions/A/Headers/pjmedia-codec/config.h
#   endif
#endif
