...
typedef struct pjmedia_srtp_roc
{
     ...
     */
<<<<<<< HEAD:VialerPJSIP.framework/Versions/A/Headers/pjmedia/transport_srtp.h
    pj_uint32_t     ssrc;
=======
    pj_uint32_t	    ssrc;
>>>>>>> xcframework:iphoneos/VialerPJSIP.framework/Versions/A/Headers/pjmedia/transport_srtp.h
