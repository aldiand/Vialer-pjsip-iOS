...
<<<<<<< HEAD:VialerPJSIP.framework/Versions/A/Headers/pjmedia/transport_ice.h
    pj_str_t    loc_ufrag;
    pj_str_t    rem_ufrag;
=======
    pj_str_t	loc_ufrag;
    pj_str_t	rem_ufrag;
>>>>>>> xcframework:iphoneos/VialerPJSIP.framework/Versions/A/Headers/pjmedia/transport_ice.h
