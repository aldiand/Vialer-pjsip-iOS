 ...
 *
<<<<<<< HEAD:VialerPJSIP.framework/Versions/A/Headers/pjmedia/wav_playlist.h
 ...
 *			is about 4KB).
 * @param p_port	Pointer to receive the file port instance.
>>>>>>> xcframework:iphoneos/VialerPJSIP.framework/Versions/A/Headers/pjmedia/wav_playlist.h
 *
