...
<<<<<<< HEAD:VialerPJSIP.framework/Versions/A/Headers/pjnath/turn_session.h
                                            pj_turn_session *sess,
                                            pj_pool_t *pool,
                                            pj_uint32_t conn_id,
                                            const pj_sockaddr_t *peer_addr,
...
=======
					    ...
					    const pj_sockaddr_t *peer_addr,
					    unsigned addr_len);
>>>>>>> xcframework:iphoneos/VialerPJSIP.framework/Versions/A/Headers/pjnath/turn_session.h
/**
