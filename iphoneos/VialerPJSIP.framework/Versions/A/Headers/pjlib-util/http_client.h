 ...
 *
<<<<<<< HEAD:VialerPJSIP.framework/Versions/A/Headers/pjlib-util/http_client.h
 ...
 * @param name	        The header field name.
 * @param val	        The header field value.
>>>>>>> xcframework:iphoneos/VialerPJSIP.framework/Versions/A/Headers/pjlib-util/http_client.h
 *
